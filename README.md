...
<h3 align="center">A Cloud Playground for Wireless Security</h3>
...
If the following error is printed out:

```txt
[ERROR] Failed to issue license
```

It generally means that the server side is temporarily offline.

## Documentation

Head over to the [usage](https://colabar.github.io/nopfire/usage) to start playing!
